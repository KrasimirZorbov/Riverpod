  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ref.read(todosProvider.notifier).createperson();
        },
      ),
    );
  }
...
class _TodoView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final filterType = ref.watch(currentFilterTypeProvider);
      ...
      children: [
        ...
        SegmentedButton(
          ...
          onSelectionChanged: (value) {
            ref.read(currentFilterTypeProvider.notifier).changeCurrentFilter(value.first);
          },
        ),
